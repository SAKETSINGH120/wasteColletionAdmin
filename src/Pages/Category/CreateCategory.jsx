...
import { createCategoryApi } from "../../Services/CategoryApi"; // Assuming this service exists

const CreateCategory = () => {
  const [formData, setFormData] = useState({
    name: "",
    priority: "", // Default as per payload
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await createCategoryApi(dataToSend);
      if (res.status) {
  ...
  return (
    <div className="">
      <div className=" bg-white p-6 max-w-9xlrounded-xl shadow-xl">
