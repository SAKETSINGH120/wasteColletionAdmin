...
import { createBannerApi } from "../../Services/BannerApi"; // Assuming this service exists

const CreateSimpleBanner = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await createBannerApi(dataToSend);
      if (res.status) {
...
export default CreateSimpleBanner;
