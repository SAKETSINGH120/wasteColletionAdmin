...
import { createDeliveryBoyApi } from "../../Services/DeliveryBoyApi";
...
const CreateDeliveryBoy = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await createDeliveryBoyApi(dataToSend);
      if (res.status) {
    ...
    <div className="p-8 bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen">
      <div className="bg-white p-6 max-w-9xl rounded-xl shadow-xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            {loading ? "Creating..." : "Create Pickup Boy"}
          </button>
        </form>
      </div>
    </div>
